...
[
  {"id":"shot01_chunk01","shot_id":"shot01","text":"3月7号Karpathy发了630行代码，autoResearch，23天60000 stars。Fortune杂志叫它The Karpathy Loop。","text_normalized":"...","status":"transcribed","char_count":78,"duration_s":8.5},
  {"id":"shot02_chunk01","shot_id":"shot02","text":"yoyo-evolve，一个Rust写的agent，每8小时自动改一轮自己的源码。它的操作对象是自身代码，评估函数是cargo test加mutation testing。约束系统是一个IDENTITY.md，8条不可变规则。Skill Creator 2.0也一样——操作对象是skill描述文本，四要素齐全，连评估函数都用了验证集六四分割。","text_normalized":"...","status":"transcribed","char_count":172,"duration_s":20.5}
]
CHUNKS_EOF
...
[{"id":"c1","shot_id":"s1","text":"第一句话。第二句话。第三句话。第四句话。第五句话。","text_normalized":"...","status":"transcribed","char_count":25,"duration_s":5.0}]
EOF
...
[{"id":"c1","shot_id":"s1","text":"测试无词级数据的场景。第二句。","text_normalized":"...","status":"transcribed","char_count":15,"duration_s":3.0}]
EOF
...
[
  {"id":"shot01_chunk01","shot_id":"shot01","text":"第一句","text_normalized":"第一句","status":"transcribed","duration_s":1.0,"file":"shot01_chunk01.wav"},
  {"id":"shot01_chunk02","shot_id":"shot01","text":"第二句话更长","text_normalized":"第二句话更长","status":"transcribed","duration_s":2.0,"file":"shot01_chunk02.wav"},
  {"id":"shot02_chunk01","shot_id":"shot02","text":"另一个段落","text_normalized":"另一个段落","status":"transcribed","duration_s":1.5,"file":"shot02_chunk01.wav"}
]
EOF
...
[{"id":"empty_chunk","shot_id":"empty_shot","text":"","text_normalized":"","status":"transcribed","duration_s":0,"file":null}]
EOF
